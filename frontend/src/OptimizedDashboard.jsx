...
function OptimizedDashboard() {
  ...
  const getRiskColor = (score) => {
    ...
    if (score <= 50) return '#ff9f1c'  // Orange
      ...
      case 'apk':
        return (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-8">
              <div
                className={`upload-container border-2 border-dashed rounded-xl p-8 text-center transition-all ${
                  dragActive 
      ...
      return (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              <div className="permissions-container space-y-6">
                {['normal', 'dangerous', 'special'].map(category => (
                  <div key={category} className="permission-block">
                    <h4 className="font-bold mb-3 text-lg" style={{color: category === 'normal' ? '#2ecc71' : category === 'dangerous' ? '#ff9f1c' : '#ff4d4f'}}>
          ...
          <div className="space-y-6">
            {result ? (
                  ...
                  <div className="report-container">
                    <div className="export-card">
                      <div className="report-icon">
                        <svg width="120" height="120" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="report-svg">
              ...
              <div className="result-placeholder">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-2">No Analysis Results</h2>
